...
description: Step-by-step guide to create a Paella Player for Opencast based on the opencast-engage-paella-player example.
---
import { Steps } from '@astrojs/starlight/components';


This guide will show you how to create a complete Paella Player for Opencast, based on the `opencast-engage-paella-player` example included in this project.

## Project Structure

The opencast-engage-paella-player is a complete web application that includes:
