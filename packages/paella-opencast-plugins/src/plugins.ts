...
import OpencastDownloadsPlugin, {
    type OpencastDownloadsPluginConfig,
} from './plugins/org.opencast.paella.downloadsPlugin';
import OpencastEditorPlugin, {
    type OpencastEditorPluginConfig,
} from './plugins/org.opencast.paella.editorPlugin';
...
import OpencastMatomoUserTrackingDataPlugin, {
    type OpencastMatomoUserTrackingDataPluginConfig,
} from './plugins/org.opencast.paella.matomo.userTrackingDataPlugin';
import OpencastRelatedVideosDataPlugin, {
    type OpencastRelatedVideosDataPluginConfig,
} from './plugins/org.opencast.paella.data.relatedVideosDataPlugin';
...
export {
    ...
    type OpencastMatomoUserTrackingDataPluginConfig,
    OpencastRelatedVideosDataPlugin,
    type OpencastRelatedVideosDataPluginConfig,
    OpencastRelatedDocumentsDataPlugin,
    type OpencastRelatedDocumentsDataPluginConfig,
};
