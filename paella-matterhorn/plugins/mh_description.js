paella.plugins.MHDescriptionPlugin  = Class.create(paella.TabBarPlugin,{
	...
	insertDescription:function() {
		...
		divSeries.innerHTML = paella.dictionary.translate("Serie:")+'<span class="showMHDescriptionTabBarValue"><a href="' + paella.player.config.restServer.url + 'engage/ui/index.html?series='+this.desc.serieId+'">'+this.desc.serie+'</a></span>';
		divPresenter.innerHTML = paella.dictionary.translate("Presenter:")+'<span class="showMHDescriptionTabBarValue"><a href="' + paella.player.config.restServer.url + 'engage/ui/index.html?q='+this.desc.presenter+'">'+this.desc.presenter+'</a></span>';
